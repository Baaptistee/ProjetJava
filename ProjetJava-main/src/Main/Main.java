...
/******************************************************** CHEVALIER ***********************************************************/
		...
		InnerNode n40C= new TestNode("", "En fouillant le jardin près de la forêt, l'équipe découvre une plante qui ressemble étrangement au Valavumdum. Le Mage va faire un test d'intelligence", "image/ExterieurchateauForet.jpg", Statistiques.INTELLIGENCE, 15, 2);
